...
const MainBooks = () => {
  ...
  const [myState, setMyState] = useState("Placeholder"); // Define your state variable here
  const [orientation, setOrientation] = useState("Portrait"); // Define your orientation variable here
  ...
  return (
    ...
    <div>
      ...
      <div className="container">
        ...
        <div>
          State: <i>{myState}</i>, orientation: <i>{orientation}</i>
        </div>
      </div>
    </div>
  );
